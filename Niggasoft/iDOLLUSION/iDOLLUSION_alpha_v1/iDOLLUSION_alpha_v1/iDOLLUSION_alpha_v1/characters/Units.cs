...
//Unit variables
            ...
            public Units(Idol idol1, Idol idol2)
            {
                ...
                unitUnity = generateUnityValue(unitMembers);
            ...
            public Units(Idol idol1, Idol idol2, Idol idol3, Idol idol4)
            {
                ...
                this.unitLeader = idol1; //set idol1 as unitleader of this unit
                unitLeaders.Add(idol1);
                unitUnity = generateUnityValue(unitMembers); //Generates unity value by taking the unity value of all members of the list, averaging them, and then casting to int.
